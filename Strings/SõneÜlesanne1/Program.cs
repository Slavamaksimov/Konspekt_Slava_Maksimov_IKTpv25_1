...
namespace SõneÜlesanne1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("kust ajamasna said? kuidas rockstar sellega juba valmis sai? o_õ");
            }
